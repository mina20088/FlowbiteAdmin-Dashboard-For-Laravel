          ...
          <ul class="pb-2 space-y-2">
            ...
            <li>
              ...
              <ul id="dropdown-playground" class="space-y-2 py-2 hidden ">
                ...
                <li>
                  <a href="https://flowbite-admin-dashboard.vercel.app/playground/sidebar/" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  bg-gray-100 dark:bg-gray-700 ">Sidebar</a>
                </li>
              </ul>
            </li>
          </ul>

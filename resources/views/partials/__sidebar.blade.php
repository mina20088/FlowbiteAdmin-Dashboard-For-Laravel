        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <x-dashboard.sidebar.drop-down-button :controls="1">
                        ...
                        <x-dashboard.sidebar.drop-down-wrapper :controls="1">
                          <li>
                              <x-dashboard.sidebar.item path="https://flowbite-admin-dashboard.vercel.app/layouts/stacked/"
                                  content="Stacked" :isSingleItem=false />
                          </li>
                          <li>
                              <x-dashboard.sidebar.item path="https://flowbite-admin-dashboard.vercel.app/layouts/sidebar/"
                                  content="Sidebar" :isSingleItem=false />
                          </li>
                    ...
                    <li>
                        ...
                        <x-dashboard.sidebar.drop-down-wrapper :controls="2">
                          <li>
                            <x-dashboard.sidebar.item path="https://flowbite-admin-dashboard.vercel.app/crud/products/" content="Products" :isSingleItem='false'/>
                          </li>
                          <li>
                            <x-dashboard.sidebar.item path="https://flowbite-admin-dashboard.vercel.app/crud/users/" content="Users" :isSingleItem='false'/>
                          </li>
                        </x-dashboard.sidebar.drop-down-wrapper>
                    </li>
                    <li>
